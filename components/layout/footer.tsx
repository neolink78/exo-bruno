...
const Footer = () => {
    ...
    <Image style={{marginTop: '4.1rem'}} src='/award.svg' alt="award" width={130} height={98}/>
     ...
     <div className="layout_footer_footer">
        ...
        <Image style={{cursor: 'pointer'}} src='/instagram.svg' alt="instagram icon" width={20} height={20}/>
        <Image style={{cursor: 'pointer'}} src='/twitter.svg' alt="twitter icon" width={20} height={20}/>
        <Image style={{cursor: 'pointer'}} src='/youtube.svg' alt="youtube icon" width={20} height={20}/>
        <Image style={{cursor: 'pointer'}} src='/linkedin.svg' alt="linkedin icon" width={20} height={20}/>
        </div>
